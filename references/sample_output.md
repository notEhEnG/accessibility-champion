...
🔴 Critical (3 issues)
  ...
  [button-name] line 23: <button> has no accessible name (empty inner text, no aria-label, and no descriptive child images/svgs)
...
🟠 Serious (5 issues)
  ...
  [link-name] line 28: Link with generic text "click here" (matches phrase "click here") — meaningless out of context
...
🔵 Minor (4 issues)
  ...
  [missing-header-landmark] line 1: Page is missing a <header> or role='banner' landmark (manual review recommended)
  → WCAG: 1.3.1 Info and Relationships
  → Fix: Wrap page headers in a <header> element or add role='banner'

  [missing-nav-landmark] line 1: Page is missing a <nav> or role='navigation' landmark (manual review recommended)
  → WCAG: 1.3.1 Info and Relationships
  → Fix: Wrap page navigation in a <nav> element or add role='navigation'

  [missing-footer-landmark] line 1: Page is missing a <footer> or role='contentinfo' landmark (manual review recommended)
  → WCAG: 1.3.1 Info and Relationships
